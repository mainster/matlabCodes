...
void PID0_step(void)
{
   ...
   *  Inport: '<Root>/u'
   */
  PID0_B.ProportionalGain = 406.220491913229 * PID0_U.e;
   ...
   *  Inport: '<Root>/u'
   */
  PID0_B.DerivativeGain = (-0.00567196917468385) * PID0_U.e;
  ...
  PID0_B.FilterCoefficient = 36769.7002550283 * PID0_B.SumD;
   ...
   *  Inport: '<Root>/u'
   */
  PID0_B.IntegralGain = 112878.065273991 * PID0_U.e;
  ...
  if (PID0_B.Sum > 1.25) {
    PID0_B.DeadZone = PID0_B.Sum - 1.25;
  } else if (PID0_B.Sum >= (-1.25)) {
    PID0_B.DeadZone = 0.0;
  } else {
    PID0_B.DeadZone = PID0_B.Sum - (-1.25);
  }
  ...
  PID0_DW.Integrator_DSTATE = 1.0E-5 * PID0_B.Switch + PID0_DW.Integrator_DSTATE;

  /* Update for DiscreteIntegrator: '<S1>/Filter' */
  PID0_DW.Filter_DSTATE = 1.0E-5 * PID0_B.FilterCoefficient +
...
void PID0_initialize(void)
{
  ...
  rtmSetTFinal(PID0_M, 0.001);
  PID0_M->Timing.stepSize0 = 1.0E-5;
