function hzx = pzg_ishzx( dom_ndx, ploth_ndx )
% Returns the value of "Hz" checkbox in specified figure
...
hz_cb_h = pzg_fndo( dom_ndx, ploth_ndx,'BodeHZChkbox');
if ~isempty(hz_cb_h)
  hzx = get( hz_cb_h(1),'value');
end
