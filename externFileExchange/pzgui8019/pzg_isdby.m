function dby = pzg_isdby( dom_ndx, ploth_ndx )
% Returns the value of "dB" checkbox in specified figure.
...
ploth_ndx = ploth_ndx( ( ploth_ndx == 1 ) & ( ploth_ndx == 3 ) );
if isempty(ploth_ndx)
  ploth_ndx = [1;3];
end
  
db_cb_h = pzg_fndo( dom_ndx, ploth_ndx,'BodeDBChkbox');
if ~isempty(db_cb_h)
  dby = get( db_cb_h(1),'value');
end
