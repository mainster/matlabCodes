...
#ifndef ex_codegen_dsp_COMMON_INCLUDES_
# define ex_codegen_dsp_COMMON_INCLUDES_
#include <math.h>
#include <stddef.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* ex_codegen_dsp_COMMON_INCLUDES_ */
...
#define ex_codegen_dsp_rtModel         RT_MODEL_ex_codegen_dsp_T

/* Block signals (auto storage) */
typedef struct {
  real_T RandomSource;                 /* '<Root>/Random Source' */
  real_T LMSFilter_o3[32];             /* '<Root>/LMS Filter' */
...
typedef struct {
  ...
  real_T GeneratedFilterBlock_states[31];/* '<S1>/Generated Filter Block' */
  ...
  struct {
    void *LoggedData;
  } SignalToWorkspace_PWORK;           /* '<Root>/Signal To Workspace' */
...
#define rtB                            ex_codegen_dsp_B
#define BlockIO                        B_ex_codegen_dsp_T
#define rtP                            ex_codegen_dsp_P
#define Parameters                     P_ex_codegen_dsp_T
#define rtDWork                        ex_codegen_dsp_DW
#define D_Work                         DW_ex_codegen_dsp_T

/* Parameters (auto storage) */
struct P_ex_codegen_dsp_T_ {
  real_T SineWave_Amplitude;           /* Expression: Amplitude
                                        * Referenced by: '<Root>/Sine Wave'
                                        */
  real_T SineWave_Frequency;           /* Expression: Frequency
                                        * Referenced by: '<Root>/Sine Wave'
                                        */
  real_T SineWave_Phase;               /* Expression: Phase
                                        * Referenced by: '<Root>/Sine Wave'
                                        */
 ...
 *
 * '<Root>' : 'ex_codegen_dsp'
 * '<S1>'   : 'ex_codegen_dsp/Lowpass Filter'
 */
