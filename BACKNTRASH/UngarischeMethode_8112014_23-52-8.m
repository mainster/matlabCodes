...
subplot(su(1));
lh1=legend(fnameR([1,2]),'Interpreter','none');
subplot(su(2));
lh2=legend(fnameR([1,3]),'Interpreter','none');
subplot(su(3));
lh3=legend(fnameR([1,4]),'Interpreter','none');
