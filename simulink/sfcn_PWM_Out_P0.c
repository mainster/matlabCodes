 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
 * Created: Sat Apr 19 21:51:04 2014
 * 
 *
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME sfcn_PWM_Out_P0
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void sfcn_PWM_Out_P0_Outputs_wrapper(const uint8_T *in,
                           
			      const real_T  *xD,
                          const uint8_T  *pin, const int_T p_width0);
extern void sfcn_PWM_Out_P0_Update_wrapper(const uint8_T *in 
                           real_T *xD, 
                          const uint8_T  *pin, const int_T  p_width0);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    sfcn_PWM_Out_P0_Outputs_wrapper(in, xD, pin, p_width0);
}
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    sfcn_PWM_Out_P0_Update_wrapper(in,  xD, pin, p_width0);
}
