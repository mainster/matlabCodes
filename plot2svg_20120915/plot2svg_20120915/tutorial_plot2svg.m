...
%h=plot(ff,10*log10(Npsd.Data),'Color','blue'); grid on;

h(1)=plot(ff,10*log10(Wpsd.Data),'Color',COL_WHITE); grid on;
% plot(ff,10*log10(Wpsd)); grid on;
h(2)=plot(ff,10*log10(Ppsd.Data),'Color',COL_PINK); grid on;
h(3)=plot(ff,10*log10(Rpsd.Data),'Color',COL_RED); grid on;
