% Programm ls_1.m zur rekursiven Löšsung der Least-Square Gleichung
% füŸr die Koeffizienten eines FIR-Filters (Informationsform)
...
% ------- GeschäŠtztes Filter und Initialisierungen
M = 15;
