% Programm nlm2.m zur Untersuchung der nlm-Methode
...
% --------- Eine Sequenz für die Darstellung
...
L = 20;  % Anzahl der Sequenzen, die gemittelt werden
sumH = zeros(1,N);
sumY2 = sumH;

for k = 1:L   % Die Ergebnisse der L-Sequenzen werden gemittelt
    phi = 2*pi*rand(1,N/2-1);           % N/2-1 Werte
    ...
    vin = [(0:511)', v'];  % Eingangsmatrix für das Modell nlm_1.mdl
    sim('nlm_1', [0, 511]);% Aufruf der Simulation mit Modell nlm_1.mdl
