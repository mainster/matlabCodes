% Programm cic_dezim_13_.m zur Parametrierung des Modells 
% cic_dezim3_.mdl 
...
%cfir_fix.ProductMode = 'FullPrecision'; % (default)
%cfir_fix.AccumMode = 'FullPrecision';

cfir_fix.FilterInternals = 'SpecifyPrecision';
cfir_fix.OutputWordLength = 16;
cfir_fix.OutputFracLength = 8;

cfir_fix.InputWordLength = 32;
cfir_fix.InputFracLength = 16;

cfir_fix.RoundMode = 'Floor';
cfir_fix.OverflowMode = 'saturate';

figure(3);     clf;
hpsd = noisepsd(cfir_fix,20,'NormalizedFrequency', 0,...
    'Fs',2000); % 2000 ist die Abtastfrequenz
plot(hpsd);                  
