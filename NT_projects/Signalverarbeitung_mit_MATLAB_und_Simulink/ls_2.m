% Programm ls_2.m zur rekursiven Löšsung der Least-Square Gleichung
% füŸr die Koeffizienten eines FIR-Filters (Covarianzform)
...
% ------- GeschŠtztes Filter und Initialisierungen
M = 15;
w = 1;  % Forgetting Faktor
x_temp1 = zeros(nf,1); % FüŸr das korrekte Filter
x_temp = zeros(M,1);   % FüŸr das zu identif. Filter
