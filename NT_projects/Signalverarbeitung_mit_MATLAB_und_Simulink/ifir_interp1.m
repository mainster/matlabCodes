% Programm ifir_interp1.m zur Parametrierung des Modells
% ifir_interp_1.mdl in dem eine Interpolierung mit 
...
delay = fix((length(h)-1)/2 + (length(himage)-1)/(2*L));

% -------- Aufruf der Simulation
sim('ifir_interp_1',[0,1]);
