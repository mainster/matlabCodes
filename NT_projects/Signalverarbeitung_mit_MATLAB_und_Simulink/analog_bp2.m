% Programm analog_bp2.m zur Untersuchung von
% Bandpassfiltern
% Mittenfrequenz gegeben durch arithmetischer Mittelwert
clear
% --------- Spezifizierung
f1 = 30000;    w1 = 2*pi*f1; 
f2 = 35000;    w2 = 2*pi*f2;
...
% Frequenzbereich
%alpha_min = floor(log10(f1));
%alpha_max = ceil(log10(f2));

alpha_min = (log10(f1*0.8));
alpha_max = (log10(f2*1.2));
