function b = fir_fenster21(fr, nord);
% Funktion fir_fenster21 zur Entwicklung von zwei
% Gruppen von FIR-Tiefpassfiltern mit Fensterverfahren
% fr = relative Durchlassfrequenz (zur Nyquist-Frequenz)
...
for p = 1:2
    for k = 1:4
       [Hf(:,k,p),w] = freqz(b(:,k,p), 1, nf, 'whole', 1);
    end;   
end;
