% Programm iirlpnorm_1.m zur Entwicklung von 
% IIR-Filtern mit der Funktion iirlpnorm

clear;

% --------- Filter Spezifikation
fp = [20.5, 23.5]*1.e3;  % Durchlassbereich 
...
m = [0 0 1 1 0 0];        % Vektor Amplitudengänge
edges = f;           % Vektor der Grenzen der Bereichen
Wb = [1 5 5 5 5 1];  % Vektor der Bewertung

[b,a]=iirlpnorm(nz,nn,f,edges,m, Wb);
