...
%genComplSinFS(fc,fs,n,Are,Aim,phi,DCre,DCim)

% Matlab3
%[t,s1] = genComplSinFS(fc, fs, n, 0.5, 0.5, 0, 0, 0);       
%[t,s2] = genComplSinFS(fc, fs, n, 0.5, 0.4, 0, 0, 0);      
%[t,s3] = genComplSinFS(fc, fs, n, 0.4, 0.5, 0, 0, 0);      

% Screenshot 2
% Prototyp: genComplSinFS(fc,fs,n,Are,Aim,phi,DCre,DCim)
%
% s1:   symmetrische Amplituden, kein Offset oder Phasenfehler
[t,s1] = genComplSinFS(fc, fs, n, 0.4, 0.4, 0, 0, 0);       
% s2:   symmetrische Amplituden, Phasenfehler, kein Offset
[t,s2] = genComplSinFS(fc, fs, n, 0.4, 0.4, 25, 0, 0);      
% s3:   symmetrische Amplituden, Imag. Offset, Phasenfehler  
[t,s3] = genComplSinFS(fc, fs, n, 0.4, 0.4, -25, 0, 0.1); 
...
% s1:   symmetrische Amplituden, kein Offset oder Phasenfehler
[t,s1] = genComplSinFS(fc, fs, n, 0.4, 0.4, 0, 0, 0);       
% s2:   unsymmetrische Amplituden, kein Offset oder Phasenfehler
[t,s2] = genComplSinFS(fc, fs, n, 0.4, 0.5, 0, 0, 0);      
% s3:   symmetrische Amplituden, Imag. Offset, kein Phasenfehler  
[t,s3] = genComplSinFS(fc, fs, n, 0.3, 0.3, 0, 0, 0.15); 
