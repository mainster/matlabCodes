...
MODEL                = ex_codegen_dsp
MODULES              = ex_codegen_dsp_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c 
MAKEFILE             = ex_codegen_dsp.mk
MATLAB_ROOT          = /usr/local/MATLAB/R2013a
ALT_MATLAB_ROOT      = /usr/local/MATLAB/R2013a
MATLAB_BIN           = /usr/local/MATLAB/R2013a/bin
MASTER_ANCHOR_DIR    = 
START_DIR            = /home/mainster/CODES_local/matlab_workspace/codegenerator_tests
S_FUNCTIONS          = 
S_FUNCTIONS_LIB      = 
SOLVER               = 
NUMST                = 1
...
ADD_INCLUDES = \
	-I$(START_DIR)/ex_codegen_dsp_grt_rtw \
	-I$(START_DIR) \
