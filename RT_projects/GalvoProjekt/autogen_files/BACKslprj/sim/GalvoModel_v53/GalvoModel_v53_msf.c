...
#define S_FUNCTION_NAME GalvoModel_v53_msf
#endif
...
#define rt_logging_h
#include "GalvoModel_v53_types.h"
#include "GalvoModel_v53.h"
#include "GalvoModel_v53_private.h"
MdlRefChildMdlRec childModels [ 1 ] = { "GalvoModel_v53" , "GalvoModel_v53" ,
...
fcn = S -> mdlInfo -> genericFcn ; real_T lifeSpan = rtInf ; real_T startTime
= 0.0 ; real_T stopTime = 10.0 ; int_T hwSettings [ 13 ] ; int_T opSettings [
1 ] ; boolean_T concurrTaskSupport = 0 ; boolean_T hasDiscTs = 0 ;
ModelRefChildSolverInfo solverInfo = { 0 , - 1 , 0.001 , 0.0001 , 0.0 , 0.0 }
...
( S , 0 , 0.0 ) ; if ( ! ssSetNumOutputPorts ( S , 3 ) ) return ; if ( !
...
mr_GalvoModel_v53_MdlInfoRegFcn ( S , "GalvoModel_v53" , & retVal ) ; if ( !
retVal ) return ; }
#endif
...
real_T * ) ssGetContStates ( S ) ; kvvmqzdoiu ( rtx ) ; }
...
sysTid ) ; if ( sysTid == CONSTANT_TID ) { sysTid = 0 ; } dgz4m3u3m1 ( S ,
ssGetSampleTimeTaskID ( S , 0 ) , rtx , sysRanPtr , sysTid , ( NULL ) , (
NULL ) , 0 , - 1 ) ; ssSetModelMappingInfoPtr ( S , & ( jycjl4j2dd . rtm .
...
ssGetOutputPortSignal ( S , 1 ) ; real_T * OutPort_2 = ( real_T * )
ssGetOutputPortSignal ( S , 2 ) ; real_T * rtx = ( real_T * ) ssGetContStates
( S ) ; if ( tid != CONSTANT_TID ) { GalvoModel_v53 ( OutPort_0 , OutPort_1 ,
OutPort_2 , rtx ) ; } }
#define MDL_UPDATE
static void mdlUpdate ( SimStruct * S , int_T tid ) { const real_T * InPort_0
= ( real_T * ) ssGetInputPortSignal ( S , 0 ) ; musrh40ndy ( InPort_0 ) ; }
#define MDL_ZERO_CROSSINGS
static void mdlZeroCrossings ( SimStruct * S ) { const real_T * InPort_0 = (
real_T * ) ssGetInputPortSignal ( S , 0 ) ; real_T * rtzcsv = ( real_T * )
ssGetNonsampledZCs ( S ) ; ewvetx1tlq ( InPort_0 , rtzcsv ) ; }
#define MDL_DERIVATIVES
static void mdlDerivatives ( SimStruct * S ) { const real_T * InPort_0 = (
real_T * ) ssGetInputPortSignal ( S , 0 ) ; real_T * OutPort_1 = ( real_T * )
ssGetOutputPortSignal ( S , 1 ) ; real_T * rtxdot = ( real_T * ) ssGetdX ( S
) ; nibvssgug0 ( InPort_0 , OutPort_1 , rtxdot ) ; } static void mdlTerminate
( SimStruct * S ) { }
