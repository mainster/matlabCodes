...
#define stm32_pid_v1_mod_rtModel       RT_MODEL_stm32_pid_v1_mod_T
...
typedef struct {
  ...
  real_T DiscreteZeroPole1;            /* '<Root>/Discrete Zero-Pole1' */
  real_T Sum_o;                        /* '<Root>/Sum' */
  real_T ProportionalGain_a;           /* '<S2>/Proportional Gain' */
  real_T Integrator_o;                 /* '<S2>/Integrator' */
  real_T DerivativeGain_o;             /* '<S2>/Derivative Gain' */
  real_T Filter_c;                     /* '<S2>/Filter' */
  real_T SumD_e;                       /* '<S2>/SumD' */
  real_T FilterCoefficient_m;          /* '<S2>/Filter Coefficient' */
  real_T Sum_ot;                       /* '<S2>/Sum' */
  real_T Saturation;                   /* '<S2>/Saturation' */
  real_T IntegralGain_m;               /* '<S2>/Integral Gain' */
} B_stm32_pid_v1_mod_T;

/* Block states (auto storage) for system '<Root>' */
typedef struct {
  real_T DiscreteZeroPole_DSTATE[2];   /* '<Root>/Discrete Zero-Pole' */
  real_T Filter_DSTATE;                /* '<S1>/Filter' */
  real_T Integrator_DSTATE;            /* '<S1>/Integrator' */
  real_T DiscreteZeroPole1_DSTATE[2];  /* '<Root>/Discrete Zero-Pole1' */
  real_T Integrator_DSTATE_c;          /* '<S2>/Integrator' */
  real_T Filter_DSTATE_e;              /* '<S2>/Filter' */
  struct {
    void *LoggedData;
...
#define rtB                            stm32_pid_v1_mod_B
#define BlockIO                        B_stm32_pid_v1_mod_T
#define rtU                            stm32_pid_v1_mod_U
#define ExternalInputs                 ExtU_stm32_pid_v1_mod_T
#define rtY                            stm32_pid_v1_mod_Y
#define ExternalOutputs                ExtY_stm32_pid_v1_mod_T
#define rtP                            stm32_pid_v1_mod_P
#define Parameters                     P_stm32_pid_v1_mod_T
#define rtDWork                        stm32_pid_v1_mod_DW
#define D_Work                         DW_stm32_pid_v1_mod_T
...
struct P_stm32_pid_v1_mod_T_ {
  ...
  real_T PulseGenerator_Amp;           /* Expression: 0.5
                                        ...
                                        */
  real_T PulseGenerator_Period;        /* Expression: round(1/(15*Ts))
                                        * Referenced by: '<Root>/Pulse Generator'
                                        */
  real_T PulseGenerator_Duty;          /* Expression: round(0.5*1/(15*Ts))
                                        * Referenced by: '<Root>/Pulse Generator'
                                        */
  real_T PulseGenerator_PhaseDelay;    /* Expression: round(0.5*1/(15*Ts))
                                        * Referenced by: '<Root>/Pulse Generator'
                                        */
  real_T Constant_Value;               /* Expression: 1.
                                        * Referenced by: '<Root>/Constant'
                                        */
  real_T DiscreteZeroPole1_A[3];       /* Computed Parameter: DiscreteZeroPole1_A
                                        * Referenced by: '<Root>/Discrete Zero-Pole1'
                                        */
  real_T DiscreteZeroPole1_B;          /* Computed Parameter: DiscreteZeroPole1_B
                                        * Referenced by: '<Root>/Discrete Zero-Pole1'
                                        */
  real_T DiscreteZeroPole1_C[2];       /* Computed Parameter: DiscreteZeroPole1_C
                                        * Referenced by: '<Root>/Discrete Zero-Pole1'
                                        */
...
struct tag_RTM_stm32_pid_v1_mod_T {
  const char_T *path;
...
extern const rtwCAPI_ModelMappingStaticInfo*
  stm32_pid_v1_mod_GetCAPIStaticMap(void);

/* Real-time Model object */
extern RT_MODEL_stm32_pid_v1_mod_T *const stm32_pid_v1_mod_M;
