...
MODEL                = stm32_pid_v1_mod
MODULES              = rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_nonfinite.c rtw_modelmap_utils.c stm32_pid_v1_mod_capi.c stm32_pid_v1_mod_data.c 
MAKEFILE             = stm32_pid_v1_mod.mk
...
MODELLIB                  = stm32_pid_v1_modlib.a
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	-I$(START_DIR)/stm32_pid_v1_mod_grt_rtw \
	-I$(START_DIR) \
