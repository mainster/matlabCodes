%COMEDI_BLOCK Blocking analog input for comedi
%	buf=COMEDI_BLOCK(device, subdevice, [min max], channels, rate, n, trig) 
...
%	scans to perform.  Trig specifies the external input channel
%	used to start the scan.  To start a scan immediately, leave trig empty.
%
