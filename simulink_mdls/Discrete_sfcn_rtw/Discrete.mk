...
#
# File    : rtwsfcn_vcx64.tmf   $Revision: 1.1.6.15 $
#
# Abstract:
...
MEM_ALLOC          = RT_STATIC
MEXEXT             = mexw64
BUILDARGS          =  MODELLIB=Discretelib.lib RELATIVE_PATH_TO_ANCHOR=.. MODELREF_TARGET_TYPE=NONE
CREATEMODEL        = 1
USERMODULES        =  
USEPARAMVALUES     = 0
MEX_OPT_FILE       = -f C:\Users\mainster\AppData\Roaming\MATHWO~1\MATLAB\R2013b\mexopts.bat
COMPUTER           = PCWIN64
VISUAL_VER         = 7.1SDK
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\Discrete_sfcn_rtw
