# File name: test.mk
# Autogenerated on: 24-Apr-2014 11:01:11
...
SOURCE_FILES        := $(call FORMAT_PATH,./MW_gpio.c) $(call FORMAT_PATH,./MW_pinMux.c) $(call FORMAT_PATH,./linuxUDP.c) $(call FORMAT_PATH,./ert_main.c) $(call FORMAT_PATH,./rtGetInf.c) $(call FORMAT_PATH,./rtGetNaN.c) $(call FORMAT_PATH,./rt_nonfinite.c) $(call FORMAT_PATH,./rt_zcfcn.c) $(call FORMAT_PATH,./test.c) $(call FORMAT_PATH,./test_data.c)
HEADER_FILES        := $(call FORMAT_PATH,./rtGetInf.h) $(call FORMAT_PATH,./rtGetNaN.h) $(call FORMAT_PATH,./rt_nonfinite.h) $(call FORMAT_PATH,./rt_zcfcn.h) $(call FORMAT_PATH,./test.h)
LIBRARY_FILES       := 
...
COMPILER_CODEGEN_ARGS:= -I"./"                -O3 -D"MODEL=test" -D"NUMST=1" -D"NCSTATES=0" -D"HAVESTDIO=" -D"ONESTEPFCN=0" -D"TERMFCN=1" -D"MAT_FILE=0" -D"MULTI_INSTANCE_CODE=0" -D"INTEGER_CODE=0" -D"MT=0" -D"CLASSIC_INTERFACE=0" -D"TID01EQ=0" -D"_USE_TARGET_UDP_=" -D"_RUNONTARGETHARDWARE_BUILD_="
