# File name: spiBitbang_complete_v2_2.mk
# Autogenerated on: 24-Apr-2014 09:52:01
# Copyright 2009-2012 The MathWorks, Inc.
#
# Model: SPIBITBANG_COMPLETE_V2_2
# Template: gmake 
...
EMPTY                :=
SPACE                := $(EMPTY) $(EMPTY)
MODEL_NAME           := spiBitbang_complete_v2_2
...
SOURCE_FILES        := $(call FORMAT_PATH,.\MW_gpio.c) $(call FORMAT_PATH,.\MW_pinMux.c) $(call FORMAT_PATH,.\linuxUDP.c) $(call FORMAT_PATH,.\ert_main.c) $(call FORMAT_PATH,.\rtGetInf.c) $(call FORMAT_PATH,.\rtGetNaN.c) $(call FORMAT_PATH,.\rt_nonfinite.c) $(call FORMAT_PATH,.\rt_zcfcn.c) $(call FORMAT_PATH,.\spiBitbang_complete_v2_2.c) $(call FORMAT_PATH,.\spiBitbang_complete_v2_2_data.c)
HEADER_FILES        := $(call FORMAT_PATH,.\rtGetInf.h) $(call FORMAT_PATH,.\rtGetNaN.h) $(call FORMAT_PATH,.\rt_nonfinite.h) $(call FORMAT_PATH,.\rt_zcfcn.h) $(call FORMAT_PATH,.\spiBitbang_complete_v2_2.h)
LIBRARY_FILES       := 
...
COMPILER_CODEGEN_ARGS := -I"C:/MATLAB/SupportPackages/R2013b/linux/include" -I"C:/Users/mainster/Documents/MATLAB/simulink/spiBitbang_complete_v2_2_rtt" -I"C:/Users/mainster/Documents/MATLAB/simulink" -I"C:/Program Files/MATLAB/R2013b/extern/include" -I"C:/Program Files/MATLAB/R2013b/simulink/include" -I"C:/Program Files/MATLAB/R2013b/rtw/c/src" -I"C:/Program Files/MATLAB/R2013b/rtw/c/src/ext_mode/common" -I"C:/Program Files/MATLAB/R2013b/rtw/c/ert" -I"C:/Program Files/MATLAB/R2013b/toolbox/dsp/include" -I"C:/Program Files/MATLAB/R2013b/toolbox/dsp/extern/src/export/include/src" -I"C:/Program Files/MATLAB/R2013b/toolbox/dsp/extern/src/export/include" -I"C:/Program Files/MATLAB/R2013b/toolbox/shared/dsp/vision/matlab/include" -I"C:/MATLAB/SupportPackages/R2013b/linux/blocks/sfcn/include" -I"C:/MATLAB/SupportPackages/R2013b/linux/blocks/sfcn/src" -I"C:/Program Files/MATLAB/R2013b/toolbox/shared/dspblks/extern/include" -O3 -D"MODEL=spiBitbang_complete_v2_2" -D"NUMST=1" -D"NCSTATES=0" -D"HAVESTDIO=" -D"ONESTEPFCN=0" -D"TERMFCN=1" -D"MAT_FILE=0" -D"MULTI_INSTANCE_CODE=0" -D"INTEGER_CODE=0" -D"MT=0" -D"CLASSIC_INTERFACE=0" -D"TID01EQ=0" -D"_USE_TARGET_UDP_=" -D"_RUNONTARGETHARDWARE_BUILD_="
