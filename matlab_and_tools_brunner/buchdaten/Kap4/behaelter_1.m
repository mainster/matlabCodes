% Programm behaelter_1.m zur Parametrierung und Aufrufen des 
% Modells behaelter1.mdl, in dem ein schwingender Behälter
% simuliert wird
...
[t,x,y] = sim('behaelter1', [0:0.01:20], my_options);
