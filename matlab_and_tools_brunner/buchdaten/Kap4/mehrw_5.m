...
% -------Diskretisierung des Zustandsmodells
Ts = 0.5;       % Abtastperiode
my_system = ss(A,B,C,D);          % Systemdeklaration
my_system1 = c2d(my_system,Ts);   % Umwandlung Kontinuirlich-Diskret

% Matrizen des diskreten Zustandsmodells
a = my_system1.a;       b = my_system1.b;
c = my_system1.c;       d = my_system1.d;
...
[t,x,y] = sim('mehrw5',[0,tf],my_options);
