...
static const mxArray *c4_f_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static int32_T c4_i_emlrt_marshallIn(SFc4_mpclibInstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
...
static void initialize_params_c4_mpclib(SFc4_mpclibInstanceStruct *chartInstance)
{
  ...
  sf_mex_import_named("v_temp", sf_mex_get_sfun_param(chartInstance->S, 8, 0),
                      c4_dv1, 0, 0, 0U, 1, 0U, 1, 11);
  for (c4_i1 = 0; c4_i1 < 11; c4_i1++) {
    chartInstance->c4_v_temp[c4_i1] = c4_dv1[c4_i1];
  }
  ...
  sf_mex_import_named("r_temp", sf_mex_get_sfun_param(chartInstance->S, 7, 0),
                      c4_dv2, 0, 0, 0U, 1, 0U, 1, 20);
  for (c4_i2 = 0; c4_i2 < 20; c4_i2++) {
    chartInstance->c4_r_temp[c4_i2] = c4_dv2[c4_i2];
  }
  ...
  sf_mex_import_named("md_temp", sf_mex_get_sfun_param(chartInstance->S, 0, 0),
                      &c4_d6, 0, 0, 0U, 0, 0U, 0);
  chartInstance->c4_md_temp = c4_d6;
  sf_set_error_prefix_string("Stateflow Runtime Error (chart): ");
  sf_set_error_prefix_string(
  ...
  *chartInstance)
{
  ...
  for (c4_i4 = 0; c4_i4 < 11; c4_i4++) {
    c4_d_u[c4_i4] = (*c4_vseq)[c4_i4];
  }

  c4_e_y = NULL;
  sf_mex_assign(&c4_e_y, sf_mex_create("y", c4_d_u, 0, 0U, 1U, 0U, 1, 11), FALSE);
  ...
  const mxArray *c4_st)
{
  ...
  *c4_next_t = c4_g_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c4_u, 0)), "next_t");
  c4_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c4_u, 1)),
                        "rseq", c4_dv3);
  for (c4_i5 = 0; c4_i5 < 20; c4_i5++) {
    (*c4_rseq)[c4_i5] = c4_dv3[c4_i5];
  }

  *c4_v = c4_g_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c4_u, 2)),
    "v");
  c4_e_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c4_u, 3)),
                        "vseq", c4_dv4);
  for (c4_i6 = 0; c4_i6 < 11; c4_i6++) {
    (*c4_vseq)[c4_i6] = c4_dv4[c4_i6];
  }
...
static void sf_c4_mpclib(SFc4_mpclibInstanceStruct *chartInstance)
{
  ...
  for (c4_i7 = 0; c4_i7 < 20; c4_i7++) {
    _SFD_DATA_RANGE_CHECK((*c4_c_rseq)[c4_i7], 0U);
  }

  for (c4_i8 = 0; c4_i8 < 11; c4_i8++) {
    _SFD_DATA_RANGE_CHECK((*c4_c_vseq)[c4_i8], 1U);
  }

  for (c4_i9 = 0; c4_i9 < 2; c4_i9++) {
    _SFD_DATA_RANGE_CHECK((*c4_b_ref)[c4_i9], 2U);
  }
  ...
  for (c4_i10 = 0; c4_i10 < 2; c4_i10++) {
    _SFD_DATA_RANGE_CHECK(chartInstance->c4_yoff[c4_i10], 8U);
  }
  ...
  for (c4_i11 = 0; c4_i11 < 11; c4_i11++) {
    _SFD_DATA_RANGE_CHECK(chartInstance->c4_v_temp[c4_i11], 12U);
  }

  for (c4_i12 = 0; c4_i12 < 20; c4_i12++) {
    _SFD_DATA_RANGE_CHECK(chartInstance->c4_r_temp[c4_i12], 13U);
  }
  ...
  c4_b_hoistedGlobal = chartInstance->c4_nv;
  c4_c_hoistedGlobal = chartInstance->c4_ny;
  c4_d_hoistedGlobal = chartInstance->c4_p;
  c4_e_hoistedGlobal = chartInstance->c4_voff;
  c4_f_hoistedGlobal = chartInstance->c4_no_md;
  c4_g_hoistedGlobal = chartInstance->c4_no_ref;
  c4_h_hoistedGlobal = chartInstance->c4_md_temp;
  c4_i_hoistedGlobal = *c4_b_time;
  c4_j_hoistedGlobal = chartInstance->c4_openloopflag;
  for (c4_i13 = 0; c4_i13 < 2; c4_i13++) {
    c4_ref[c4_i13] = (*c4_b_ref)[c4_i13];
  }

  c4_md = c4_hoistedGlobal;
  c4_b_nv = c4_b_hoistedGlobal;
  c4_b_ny = c4_c_hoistedGlobal;
  c4_b_p = c4_d_hoistedGlobal;
  for (c4_i14 = 0; c4_i14 < 2; c4_i14++) {
    c4_b_yoff[c4_i14] = chartInstance->c4_yoff[c4_i14];
  }

  c4_b_voff = c4_e_hoistedGlobal;
  c4_b_no_md = c4_f_hoistedGlobal;
  c4_b_no_ref = c4_g_hoistedGlobal;
  for (c4_i15 = 0; c4_i15 < 11; c4_i15++) {
  ...
  c4_b_md_temp = c4_h_hoistedGlobal;
  c4_time = c4_i_hoistedGlobal;
  c4_b_openloopflag = c4_j_hoistedGlobal;
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_nargout, 1U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c4_ref, 2U, c4_e_sf_marshallOut);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_b_p, 6U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c4_b_yoff, 7U, c4_e_sf_marshallOut,
    c4_e_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_b_no_ref, 10U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c4_b_v_temp, 11U, c4_b_sf_marshallOut,
    c4_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c4_b_r_temp, 12U, c4_c_sf_marshallOut,
    c4_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_b_md_temp, 13U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c4_rseq, 16U, c4_c_sf_marshallOut,
    c4_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c4_vseq, 17U, c4_b_sf_marshallOut,
    c4_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_v, 18U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  ...
  for (c4_i18 = 0; c4_i18 < 2; c4_i18++) {
    c4_f_u[c4_i18] = c4_b_yoff[c4_i18];
  }
  ...
  for (c4_i19 = 0; c4_i19 < 11; c4_i19++) {
    c4_j_u[c4_i19] = c4_b_v_temp[c4_i19];
  }

  c4_j_y = NULL;
  sf_mex_assign(&c4_j_y, sf_mex_create("y", c4_j_u, 0, 0U, 1U, 0U, 1, 11), FALSE);
  for (c4_i20 = 0; c4_i20 < 20; c4_i20++) {
    c4_k_u[c4_i20] = c4_b_r_temp[c4_i20];
  }
  ...
  sf_mex_call_debug("mpcblock_refmd_mex", 4U, 14U, 14, c4_y, 14, c4_b_y, 14,
                    ...
                    &c4_b_next_t);
  c4_c_emlrt_marshallIn(chartInstance, sf_mex_dup(c4_b_rseq), "rseq", c4_dv5);
  for (c4_i21 = 0; c4_i21 < 20; c4_i21++) {
    c4_rseq[c4_i21] = c4_dv5[c4_i21];
  }

  c4_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c4_b_vseq), "vseq", c4_dv6);
  for (c4_i22 = 0; c4_i22 < 11; c4_i22++) {
    c4_vseq[c4_i22] = c4_dv6[c4_i22];
  }

  c4_v = c4_g_emlrt_marshallIn(chartInstance, sf_mex_dup(c4_b_v), "v");
  c4_next_t = c4_g_emlrt_marshallIn(chartInstance, sf_mex_dup(c4_b_next_t),
    "next_t");
  ...
  for (c4_i23 = 0; c4_i23 < 20; c4_i23++) {
    (*c4_c_rseq)[c4_i23] = c4_rseq[c4_i23];
  }

  for (c4_i24 = 0; c4_i24 < 11; c4_i24++) {
    (*c4_c_vseq)[c4_i24] = c4_vseq[c4_i24];
  }
  ...
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData)
{
  ...
  c4_y = c4_h_emlrt_marshallIn(chartInstance, sf_mex_dup(c4_v), &c4_thisId);
  sf_mex_destroy(&c4_v);
  ...
  *c4_inData)
{
  ...
  chartInstance = (SFc4_mpclibInstanceStruct *)chartInstanceVoid;
  c4_mxArrayOutData = NULL;
  for (c4_i25 = 0; c4_i25 < 11; c4_i25++) {
    c4_b_inData[c4_i25] = (*(real_T (*)[11])c4_inData)[c4_i25];
  }

  for (c4_i26 = 0; c4_i26 < 11; c4_i26++) {
  ...
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData)
{
  ...
  c4_thisId.fIdentifier = c4_identifier;
  c4_thisId.fParent = NULL;
  c4_f_emlrt_marshallIn(chartInstance, sf_mex_dup(c4_vseq), &c4_thisId, c4_y);
  sf_mex_destroy(&c4_vseq);
  for (c4_i27 = 0; c4_i27 < 11; c4_i27++) {
    (*(real_T (*)[11])c4_outData)[c4_i27] = c4_y[c4_i27];
  }
  ...
  *c4_inData)
{
  ...
  chartInstance = (SFc4_mpclibInstanceStruct *)chartInstanceVoid;
  c4_mxArrayOutData = NULL;
  for (c4_i28 = 0; c4_i28 < 20; c4_i28++) {
    c4_b_inData[c4_i28] = (*(real_T (*)[20])c4_inData)[c4_i28];
  }

  for (c4_i29 = 0; c4_i29 < 20; c4_i29++) {
  ...
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData)
{
  ...
  c4_thisId.fIdentifier = c4_identifier;
  c4_thisId.fParent = NULL;
  c4_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c4_rseq), &c4_thisId, c4_y);
  sf_mex_destroy(&c4_rseq);
  for (c4_i30 = 0; c4_i30 < 20; c4_i30++) {
    (*(real_T (*)[20])c4_outData)[c4_i30] = c4_y[c4_i30];
  }
  ...
  *c4_inData)
{
  ...
  for (c4_i31 = 0; c4_i31 < 2; c4_i31++) {
    c4_b_inData[c4_i31] = (*(real_T (*)[2])c4_inData)[c4_i31];
  }
  ...
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData)
{
  ...
  SFc4_mpclibInstanceStruct *chartInstance;
  chartInstance = (SFc4_mpclibInstanceStruct *)chartInstanceVoid;
  c4_b_yoff = sf_mex_dup(c4_mxArrayInData);
  c4_identifier = c4_varName;
  c4_thisId.fIdentifier = c4_identifier;
  c4_thisId.fParent = NULL;
  c4_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c4_b_yoff), &c4_thisId, c4_y);
  sf_mex_destroy(&c4_b_yoff);
  ...
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId, real_T c4_y[20])
{
  real_T c4_dv8[20];
  int32_T c4_i35;
  sf_mex_import(c4_parentId, sf_mex_dup(c4_u), c4_dv8, 1, 0, 0U, 1, 0U, 1, 20);
  for (c4_i35 = 0; c4_i35 < 20; c4_i35++) {
    c4_y[c4_i35] = c4_dv8[c4_i35];
  }
  ...
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId, real_T c4_y[11])
{
  real_T c4_dv9[11];
  int32_T c4_i36;
  sf_mex_import(c4_parentId, sf_mex_dup(c4_u), c4_dv9, 1, 0, 0U, 1, 0U, 1, 11);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2396076379U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2678629419U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2347714986U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2288329953U);
}
...
mxArray *sf_c4_mpclib_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("L7ibRKYsHYCnBRAMJFaYr");
...
static void mdlSetWorkWidths_c4_mpclib(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3721340854U));
  ssSetChecksum1(S,(1081057419U));
  ssSetChecksum2(S,(1201539683U));
  ssSetChecksum3(S,(60762704U));
