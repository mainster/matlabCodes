  ...
  if (nrhs>2 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"library")) {
      ...
      if (!strcmp(machineName,"mpclib")) {
        if (nrhs==3) {
          ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3152205769U);
          ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(358535516U);
          ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1201638064U);
          ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(4010047789U);
        } else if (nrhs==4) {
  ...
  nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 3:
      {
        if (strcmp(aiChksum, "r7mqSzu9NVppI5LYmFTK2C") == 0) {
     ...
     case 4:
      {
        if (strcmp(aiChksum, "L7ibRKYsHYCnBRAMJFaYr") == 0) {
  ...
  nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 3:
      {
        if (strcmp(tpChksum, "jm2YuqvvXtr9i6i0TOQQ5D") == 0) {
     ...
     case 4:
      {
        if (strcmp(tpChksum, "9jvHdYkpG1tsT0kM3feEfC") == 0) {
