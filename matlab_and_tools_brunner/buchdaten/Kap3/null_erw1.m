% Programm null_erw1.m zur Ermittlung des Frequenzgang
...
nf = 12;       % Ordnung des Filters = Anzahl-Koeffizienten - 1
h = fir1(nf, 0.4);      % Tiefpassfilter mit relativer Frequenz 0,4 
N = 128;                % Gesamte Länge mit Nullwerte
