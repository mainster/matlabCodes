...
#define SF_DEBUG_SET_DATA_VALUE_PTR(v1,v2)\
  sf_debug_set_instance_data_value_ptr(_warteschlangeMachineNumber_,chartInstance.chartNumber,chartInstance.instanceNumber,v1,(void *)(v2));
#define SF_DEBUG_UNSET_DATA_VALUE_PTR(v1)\
  sf_debug_unset_instance_data_value_ptr(_warteschlangeMachineNumber_,chartInstance.chartNumber,chartInstance.instanceNumber,v1);
#define SF_DEBUG_DATA_RANGE_CHECK_MIN_MAX(dVal,dNum,dMin,dMax)\
  sf_debug_data_range_error_wrapper_min_max(_warteschlangeMachineNumber_,\
   chartInstance.chartNumber,\
   chartInstance.instanceNumber,\
   dNum,(double)(dVal),(double)dMin,(double)dMax)
#define SF_DEBUG_DATA_RANGE_CHECK_MIN(dVal,dNum,dMin)\
  sf_debug_data_range_error_wrapper_min(_warteschlangeMachineNumber_,\
   chartInstance.chartNumber,\
   chartInstance.instanceNumber,\
   dNum,(double)(dVal),(double)dMin)
#define SF_DEBUG_DATA_RANGE_CHECK_MAX(dVal,dNum,dMax)\
  sf_debug_data_range_error_wrapper_max(_warteschlangeMachineNumber_,\
   chartInstance.chartNumber,\
   chartInstance.instanceNumber,\
   dNum,(double)(dVal),(double)dMax)
#define SF_DEBUG_ARRAY_BOUNDS_CHECK(v1,v2,v3,v4,v5) \
  sf_debug_data_array_bounds_error_check(_warteschlangeMachineNumber_,\
   chartInstance.chartNumber,\
   chartInstance.instanceNumber,\
   (v1),(v2),(v3),(v4),(v5))
#define SF_DEBUG_CAST_TO_UINT8(v1) \
  sf_debug_cast_to_uint8_T(_warteschlangeMachineNumber_,\
   chartInstance.chartNumber,\
   chartInstance.instanceNumber,\
   (v1),0,0)
#define SF_DEBUG_CAST_TO_UINT16(v1) \
  sf_debug_cast_to_uint16_T(_warteschlangeMachineNumber_,\
   chartInstance.chartNumber,\
   chartInstance.instanceNumber,\
   (v1),0,0)
#define SF_DEBUG_CAST_TO_UINT32(v1) \
  sf_debug_cast_to_uint32_T(_warteschlangeMachineNumber_,\
   chartInstance.chartNumber,\
   chartInstance.instanceNumber,\
   (v1),0,0)
#define SF_DEBUG_CAST_TO_INT8(v1) \
  sf_debug_cast_to_int8_T(_warteschlangeMachineNumber_,\
   chartInstance.chartNumber,\
   chartInstance.instanceNumber,\
   (v1),0,0)
#define SF_DEBUG_CAST_TO_INT16(v1) \
  sf_debug_cast_to_int16_T(_warteschlangeMachineNumber_,\
   chartInstance.chartNumber,\
   chartInstance.instanceNumber,\
   (v1),0,0)
#define SF_DEBUG_CAST_TO_INT32(v1) \
  sf_debug_cast_to_int32_T(_warteschlangeMachineNumber_,\
   chartInstance.chartNumber,\
   chartInstance.instanceNumber,\
   (v1),0,0)
#define SF_DEBUG_CAST_TO_SINGLE(v1) \
  sf_debug_cast_to_real32_T(_warteschlangeMachineNumber_,\
   chartInstance.chartNumber,\
   chartInstance.instanceNumber,\
   (v1),0,0)
#define SF_DEBUG_TRANSITION_CONFLICT(v1,v2) sf_debug_transition_conflict_error(_warteschlangeMachineNumber_,\
   chartInstance.chartNumber,\
   chartInstance.instanceNumber,\
   v1,v2)
#define SF_DEBUG_CHART_CALL(v1,v2,v3) sf_debug_call(_warteschlangeMachineNumber_,\
   chartInstance.chartNumber,\
   chartInstance.instanceNumber,\
   CHART_OBJECT,v1,v2,v3,_sfEvent_,\
   0,NULL,_sfTime_,1)
#define SF_DEBUG_CHART_COVERAGE_CALL(v1,v2,v3,v4) sf_debug_call(_warteschlangeMachineNumber_,\
   chartInstance.chartNumber,\
   chartInstance.instanceNumber,\
   CHART_OBJECT,v1,v2,v3,_sfEvent_,\
   v4,NULL,_sfTime_,1)
#define SF_DEBUG_STATE_TEMPORAL_THRESHOLD(v1,v2,v4) sf_debug_temporal_threshold(_warteschlangeMachineNumber_,\
   chartInstance.chartNumber,\
   chartInstance.instanceNumber,\
   (unsigned int)(v1),(v2),STATE_OBJECT,(v4))
#define SF_DEBUG_TRANS_TEMPORAL_THRESHOLD(v1,v2,v4) sf_debug_temporal_threshold(_warteschlangeMachineNumber_,\
   chartInstance.chartNumber,\
   chartInstance.instanceNumber,\
   (unsigned int)(v1),(v2),TRANSITION_OBJECT,(v4))
#define CV_EVAL(v1,v2,v3,v4) cv_eval_point(_warteschlangeMachineNumber_,\
   chartInstance.chartNumber,\
   chartInstance.instanceNumber,\
   (v1),(v2),(v3),(boolean_T)(v4))
#define CV_TRANSITION_EVAL(v1,v2) cv_eval_point(_warteschlangeMachineNumber_,\
   chartInstance.chartNumber,\
   chartInstance.instanceNumber,\
...
static SFwarteschlange_sfun_c1InstanceStruct chartInstance;
#define OutputData_c1_d7_Kunden         (((real_T *)(ssGetOutputPortSignal(chartInstance.S,1)))[0])
void warteschlange_sfun_c1(void);
...
void warteschlange_sfun_c1(void)
{
  ...
  if(chartInstance.State.is_active_warteschlange_sfun_c1==0) {
    SF_DEBUG_CHART_CALL(CHART_OBJECT,CHART_ENTER_ENTRY_FUNCTION_TAG,0);
    chartInstance.State.is_active_warteschlange_sfun_c1=1;
    ...
    chartInstance.State.is_warteschlange_sfun_c1=IN_c1_s1_Warteschlangensystem;
  ...
  } else {
    {
      ...
      if(chartInstance.State.is_warteschlange_sfun_c1==IN_c1_s1_Warteschlangensystem) {
        {
          ...
          if(chartInstance.State.is_active_c1_s4_Server_prozess) {
            switch(CV_EVAL(STATE_OBJECT,2,0,chartInstance.State.is_c1_s4_Server_prozess)) {
             ...
             case IN_c1_s5_busy:
              ...
              SF_DEBUG_CHART_CALL(TRANSITION_OBJECT,TRANSITION_BEFORE_PROCESSING_TAG,4);
              if(CV_TRANSITION_EVAL(4,(_sfTime_ >= chartInstance.LocalData.c1_d2_bz) && (SF_DEBUG_CHART_COVERAGE_CALL(TRANSITION_OBJECT,TRANSITION_GUARD_COVERAGE_TAG,4,0)))) {
                ...
                if(CV_TRANSITION_EVAL(3,((int16_T )OutputData_c1_d7_Kunden == 1) && (SF_DEBUG_CHART_COVERAGE_CALL(TRANSITION_OBJECT,TRANSITION_GUARD_COVERAGE_TAG,3,0)))) {
             ...
             case IN_c1_s6_idle:
              ...
              if(CV_TRANSITION_EVAL(7,(_sfEvent_ == event_c1_e10_Ankunft) && (SF_DEBUG_CHART_COVERAGE_CALL(TRANSITION_OBJECT,TRANSITION_GUARD_COVERAGE_TAG,7,0)))) {
                ...
                SF_DEBUG_CHART_CALL(STATE_OBJECT,STATE_ENTER_EXIT_FUNCTION_TAG,3);
                SF_DEBUG_CHART_COVERAGE_CALL(STATE_OBJECT,STATE_EXIT_COVERAGE_TAG,3,0);
                chartInstance.State.is_c1_s4_Server_prozess=IN_NO_ACTIVE_CHILD;
                SF_DEBUG_CHART_CALL(STATE_OBJECT,STATE_INACTIVE_TAG,3);
                SF_DEBUG_CHART_CALL(STATE_OBJECT,EXIT_OUT_OF_FUNCTION_TAG,3);
                SF_DEBUG_CHART_CALL(TRANSITION_OBJECT,TRANSITION_BEFORE_TRANS_ACTION_TAG,7);
                OutputData_c1_d7_Kunden = (real_T )(int16_T )((int16_T )OutputData_c1_d7_Kunden + 1);
                SF_DEBUG_CHART_COVERAGE_CALL(TRANSITION_OBJECT,TRANSITION_TRANSITION_ACTION_COVERAGE_TAG,7,0);
                chartInstance.LocalData.c1_d2_bz = (int16_T )_sfTime_;
                SF_DEBUG_CHART_COVERAGE_CALL(TRANSITION_OBJECT,TRANSITION_TRANSITION_ACTION_COVERAGE_TAG,7,1);
                SF_DEBUG_CHART_CALL(TRANSITION_OBJECT,TRANSITION_AFTER_TRANS_ACTION_TAG,7);
                SF_DEBUG_CHART_CALL(TRANSITION_OBJECT,TRANSITION_INACTIVE_TAG,7);
                enter_atomic_c1_s5_busy();
              }
              SF_DEBUG_CHART_CALL(STATE_OBJECT,EXIT_OUT_OF_FUNCTION_TAG,3);
...
static void exit_atomic_c1_s5_busy(void)
{
  ...
  SF_DEBUG_CHART_COVERAGE_CALL(STATE_OBJECT,STATE_EXIT_COVERAGE_TAG,1,1);
  if(chartInstance.State.is_c1_s4_Server_prozess==IN_c1_s5_busy) {
    SF_DEBUG_CHART_CALL(STATE_OBJECT,STATE_BEFORE_EXIT_ACTION_TAG,1);
    OutputData_c1_d7_Kunden = (real_T )(int16_T )((int16_T )OutputData_c1_d7_Kunden - 1);
    SF_DEBUG_CHART_COVERAGE_CALL(STATE_OBJECT,STATE_EXIT_COVERAGE_TAG,1,0);
    SF_DEBUG_CHART_CALL(STATE_OBJECT,STATE_AFTER_EXIT_ACTION_TAG,1);
    chartInstance.State.is_c1_s4_Server_prozess=IN_NO_ACTIVE_CHILD;
...
void sf_warteschlange_sfun_c1_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3404415101U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(14789873U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(395977595U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2458281085U);
}

static void initialize_warteschlange_sfun_c1( SimStruct *S)
{
  {
  ...
  if(ssIsFirstInitCond(S)) {
    {
      ...
      chartAlreadyPresent = sf_debug_initialize_chart(_warteschlangeMachineNumber_,
       1,
       6,
       8,
       9,
      ...
      if(chartAlreadyPresent==0) {
        ...
        sf_debug_set_chart_disable_implicit_casting(_warteschlangeMachineNumber_,chartInstance.chartNumber,0);
        sf_debug_set_chart_event_thresholds(_warteschlangeMachineNumber_,
         chartInstance.chartNumber,
         1,
         1,
         1);
...
#define SF_DEBUG_SET_DATA_PROPS(dataNumber,dataScope,isInputData,isOutputData,dataType,numDims,dimArray)\
          sf_debug_set_chart_data_props(_warteschlangeMachineNumber_,chartInstance.chartNumber,\
        ...
        sf_debug_set_chart_event_scope(_warteschlangeMachineNumber_,chartInstance.chartNumber,0,0);
#define SF_DEBUG_STATE_INFO(v1,v2,v3)\
          sf_debug_set_chart_state_info(_warteschlangeMachineNumber_,chartInstance.chartNumber,(v1),(v2),(v3))
        SF_DEBUG_STATE_INFO(5,1,0);
        SF_DEBUG_STATE_INFO(4,0,1);
        SF_DEBUG_STATE_INFO(0,0,0);
        SF_DEBUG_STATE_INFO(2,0,1);
        SF_DEBUG_STATE_INFO(1,0,0);
        SF_DEBUG_STATE_INFO(3,0,0);
#define SF_DEBUG_CH_SUBSTATE_INDEX(v1,v2)\
          sf_debug_set_chart_substate_index(_warteschlangeMachineNumber_,chartInstance.chartNumber,(v1),(v2))
#define SF_DEBUG_ST_SUBSTATE_INDEX(v1,v2,v3)\
          sf_debug_set_chart_state_substate_index(_warteschlangeMachineNumber_,chartInstance.chartNumber,(v1),(v2),(v3))
#define SF_DEBUG_ST_SUBSTATE_COUNT(v1,v2)\
          sf_debug_set_chart_state_substate_count(_warteschlangeMachineNumber_,chartInstance.chartNumber,(v1),(v2))
        sf_debug_set_chart_substate_count(_warteschlangeMachineNumber_,chartInstance.chartNumber,1);
        sf_debug_set_chart_decomposition(_warteschlangeMachineNumber_,chartInstance.chartNumber,0);
        SF_DEBUG_CH_SUBSTATE_INDEX(0,5);
        SF_DEBUG_ST_SUBSTATE_COUNT(5,2);
        SF_DEBUG_ST_SUBSTATE_INDEX(5,0,4);
        SF_DEBUG_ST_SUBSTATE_INDEX(5,1,2);
        SF_DEBUG_ST_SUBSTATE_COUNT(4,1);
        SF_DEBUG_ST_SUBSTATE_INDEX(4,0,0);
        SF_DEBUG_ST_SUBSTATE_COUNT(0,0);
        SF_DEBUG_ST_SUBSTATE_COUNT(2,2);
        SF_DEBUG_ST_SUBSTATE_INDEX(2,0,1);
        SF_DEBUG_ST_SUBSTATE_INDEX(2,1,3);
        SF_DEBUG_ST_SUBSTATE_COUNT(1,0);
        SF_DEBUG_ST_SUBSTATE_COUNT(3,0);
      }
      sf_debug_cv_init_chart(_warteschlangeMachineNumber_,chartInstance.chartNumber,chartInstance.instanceNumber,1,0,0,0);
      sf_debug_cv_init_state(_warteschlangeMachineNumber_,chartInstance.chartNumber,chartInstance.instanceNumber,5,2,0,0,0);
      sf_debug_cv_init_state(_warteschlangeMachineNumber_,chartInstance.chartNumber,chartInstance.instanceNumber,4,1,0,0,0);
      sf_debug_cv_init_state(_warteschlangeMachineNumber_,chartInstance.chartNumber,chartInstance.instanceNumber,0,0,0,0,0);
      sf_debug_cv_init_state(_warteschlangeMachineNumber_,chartInstance.chartNumber,chartInstance.instanceNumber,2,2,1,0,0);
      sf_debug_cv_init_state(_warteschlangeMachineNumber_,chartInstance.chartNumber,chartInstance.instanceNumber,1,0,0,0,0);
      sf_debug_cv_init_state(_warteschlangeMachineNumber_,chartInstance.chartNumber,chartInstance.instanceNumber,3,0,0,0,0);

      sf_debug_cv_init_trans(_warteschlangeMachineNumber_,chartInstance.chartNumber,chartInstance.instanceNumber,5,0);
      sf_debug_cv_init_trans(_warteschlangeMachineNumber_,chartInstance.chartNumber,chartInstance.instanceNumber,0,0);
      sf_debug_cv_init_trans(_warteschlangeMachineNumber_,chartInstance.chartNumber,chartInstance.instanceNumber,7,1);
      sf_debug_cv_init_trans(_warteschlangeMachineNumber_,chartInstance.chartNumber,chartInstance.instanceNumber,4,1);
      sf_debug_cv_init_trans(_warteschlangeMachineNumber_,chartInstance.chartNumber,chartInstance.instanceNumber,3,1);
      sf_debug_cv_init_trans(_warteschlangeMachineNumber_,chartInstance.chartNumber,chartInstance.instanceNumber,1,0);
      sf_debug_cv_init_trans(_warteschlangeMachineNumber_,chartInstance.chartNumber,chartInstance.instanceNumber,2,1);
      sf_debug_cv_init_trans(_warteschlangeMachineNumber_,chartInstance.chartNumber,chartInstance.instanceNumber,6,0);
#define SF_DEBUG_STATE_COV_WTS(v1,v2,v3,v4)\
        sf_debug_set_instance_state_coverage_weights(_warteschlangeMachineNumber_,chartInstance.chartNumber,chartInstance.instanceNumber,(v1),(v2),(v3),(v4))
#define SF_DEBUG_STATE_COV_MAPS(v1,v2,v3,v4,v5,v6,v7,v8,v9,v10) \
        sf_debug_set_chart_state_coverage_maps(_warteschlangeMachineNumber_,chartInstance.chartNumber,\
         (v1),(v2),(v3),(v4),(v5),(v6),(v7),(v8),(v9),(v10))
#define SF_DEBUG_TRANS_COV_WTS(v1,v2,v3,v4,v5) \
        sf_debug_set_instance_transition_coverage_weights(_warteschlangeMachineNumber_,chartInstance.chartNumber,chartInstance.instanceNumber,\
         (v1),(v2),(v3),(v4),(v5))
#define SF_DEBUG_TRANS_COV_MAPS(v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,v11,v12,v13) \
        sf_debug_set_chart_transition_coverage_maps(_warteschlangeMachineNumber_,chartInstance.chartNumber,\
         (v1),\
         (v2),(v3),(v4),\
         (v5),(v6),(v7),\
         (v8),(v9),(v10),\
      ...
      SF_DEBUG_STATE_COV_WTS(4,1,1,0);
      if(chartAlreadyPresent==0)
      {
        static unsigned int sStartEntryMap[] = {0};
        static unsigned int sEndEntryMap[] = {0};
      ...
      SF_DEBUG_STATE_COV_WTS(1,3,2,2);
      if(chartAlreadyPresent==0)
      {
        ...
        static unsigned int sStartExitMap[] = {90,0};
        static unsigned int sEndExitMap[] = {106,0};
      ...
      SF_DEBUG_STATE_COV_WTS(3,1,1,1);
      if(chartAlreadyPresent==0)
      {
        static unsigned int sStartEntryMap[] = {0};
        static unsigned int sEndEntryMap[] = {0};
      ...
      SF_DEBUG_TRANS_COV_WTS(7,0,1,0,2);
      if(chartAlreadyPresent==0)
      {
      ...
      SF_DEBUG_TRANS_COV_WTS(4,0,1,0,0);
      if(chartAlreadyPresent==0)
      {
      ...
      SF_DEBUG_TRANS_COV_WTS(3,0,1,0,0);
      if(chartAlreadyPresent==0)
      {
        static unsigned int sStartGuardMap[] = {1};
      ...
      SF_DEBUG_TRANS_COV_WTS(1,0,0,0,0);
      if(chartAlreadyPresent==0)
      {
    ...
    sf_debug_reset_current_state_configuration(_warteschlangeMachineNumber_,chartInstance.chartNumber,chartInstance.instanceNumber);
  }
  {
...
void warteschlange_sfun_c1_sizes_registry(SimStruct *S)
{
...
void terminate_warteschlange_sfun_c1(SimStruct *S)
{
}
static void mdlRTW_warteschlange_sfun_c1(SimStruct *S)
{
...
void sf_warteschlange_sfun_c1( void *);
void warteschlange_sfun_c1_registry(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway = sf_warteschlange_sfun_c1;
  chartInstance.chartInfo.initializeChart = initialize_warteschlange_sfun_c1;
  chartInstance.chartInfo.terminateChart = terminate_warteschlange_sfun_c1;
  chartInstance.chartInfo.mdlRTW = mdlRTW_warteschlange_sfun_c1;
  ...
  if(mxIsNaN(chartInstance.chartInfo.sampleTime)) {
    sf_mex_error_message("Error evaluating sample-time expression '1' for chart 'warteschlange/Warteschlan- gensystem' in the chart's parent workspace.");
  }
  if(chartInstance.chartInfo.sampleTime==CONTINUOUS_SAMPLE_TIME) {
    mexPrintf("Stateflow runtime error in chart warteschlange/Warteschlan- gensystem\n");
...
void sf_warteschlange_sfun_c1( void *chartInstanceVoidPtr)
{
