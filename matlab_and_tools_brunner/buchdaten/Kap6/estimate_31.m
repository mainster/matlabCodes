% Programm estimate_31.m zur Parametrierung des Experiment mit
% einem Schätzer/Beobachter (Estimator/Observer)
% Arbeitet mit dem Modell estimate31.mdl 
...
[t,x,y] = sim('estimate31', [0:dt:5], my_opt);  
