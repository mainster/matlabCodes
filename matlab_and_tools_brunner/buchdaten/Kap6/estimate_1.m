% Programm estimate_1.m zur Parametrierung des Experiment mit
% einem Schätzer/Beobachter (Estimator/Observer)
% Arbeitet mit dem Modell estimate1.mdl 

% --------MISO-System
% Ordnung 3; 2 Eingänge; 1 Ausgang
a = [-0.5, 0, 0; 0, -3, 0; 0, 0, -6];
b = [0, 0; 1, 0; 0, 1];
c = [0.3, 0.5, 1];
d = [0, 0];

my_sys = ss(a,b,c,d)    % Ohne ; um das System zu zeigen
...
% --------Schätzer
my_estim = estim(my_sys, Ke, 1, [1,2])
...
[t,x,y] = sim('estimate1', [0:dt:5], my_opt);  
